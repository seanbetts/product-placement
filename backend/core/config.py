...
class Settings(BaseSettings):
    ...
    MINIMUM_FUZZY_BRAND_MATCH_SCORE: int = 76               # Minimum fuzzy match score between original and matched text
    ...
    LENGTH_PENALTY_FACTOR: float = 0.5                      # Factor to penalize er or longer matches, reducing false positives
    ...
    MIN_HORIZONTAL_OVERLAP_RATIO_FOR_MERGE: float = 0.90    # 85% horizontal overlap required for merging
